...
var connectionString = "Server=localhost;Database=SchoolDB;User=root;Password=nader";
...
using (var scope = app.Services.CreateScope()) {
    ...
    // Create another admin user: nader
    var adminUsername2 = "nader";
    var adminPassword2 = "Nader2509";
    var adminUser2 = await userManager.FindByNameAsync(adminUsername2);
    ...
    if (adminUser2 == null)
    {
        ...
        var result2 = await userManager.CreateAsync(adminUser2, adminPassword2);
        ...
        {
            Console.WriteLine($"Failed to create admin user: {string.Join(", ", result2.Errors.Select(e => e.Description))}");
        }
    }
    else
    {
        Console.WriteLine("Admin user 'nader' already exists");
    }
}
